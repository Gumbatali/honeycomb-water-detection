...
exec conda run --no-capture-output -n studcamp python \
  ...
  --output-dir "$root/experiments/055_panel_scaled_contrast_two_stems_20epochs/artifacts" \
  ...
  --thermal-representation both --contrast-normalization panel_quantile --separate-thermal-stems \
